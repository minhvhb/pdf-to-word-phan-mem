                ...
                if st.button("✂️ Tiến hành Cắt", type="primary"):
                    if not pages_to_extract:
                        ...
                        with st.spinner("Đang cắt các trang bạn yêu cầu..."):
                            ...
                            # Phân tích chuỗi đầu vào (VD: "1, 3, 5-8")
                            ...
                            # Lọc bỏ các trang trùng lặp và sắp xếp
                            ...
                            for p_num in page_numbers:
                                if 1 <= p_num <= total_pages:
                                    writer.add_page(reader.pages[p_num - 1]) # Index bắt đầu từ 0
                                    extracted_count += 1
                                else:
...
# ==========================================
# 7. THANH MENU BÊN TRÁI ĐIỀU HƯỚNG CÁC APP
# ==========================================
...
# ==========================================
# 8. KÍCH HOẠT ỨNG DỤNG DỰA TRÊN LỰA CHỌN
# ==========================================
